...
type SecretSantaTheme struct {}

// Name returns the name of the flat theme
func (dt *SecretSantaTheme) Name() string {
	return "secretsanta"
}

// HTMLTemplate returns a Golang template that will generate an HTML email.
func (dt *SecretSantaTheme) HTMLTemplate() string {
	return `
...
func (dt *SecretSantaTheme) PlainTextTemplate() string {
	return `{{ if (ne .Email.Body.FreeMarkdown "") }}
  {{ .Email.Body.FreeMarkdown.ToHTML }}
{{ else }}
  {{ with .Email.Body.Dictionary }}
    <ul>
